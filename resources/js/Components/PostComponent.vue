    ...
    <div class="flex w-full  items-center justify-center mx-auto ">
        <div class="border w-5/6 bg-white my-3 rounded-2xl p-4 shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-80">
            ...
            <div class="mt-5 flex gap-2	 justify-center border-b pb-4 flex-wrap	">
                <img src="https://images.unsplash.com/photo-1610147323479-a7fb11ffd5dd?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1534&q=80" class="bg-red-500 w-1/3 object-cover h-96 flex-auto" alt="photo">
            </div>
